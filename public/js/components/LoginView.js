    ...
    return `
      <div class="h-screen w-screen flex items-center justify-center bg-app-canvas p-4 select-none">
        <div class="w-full max-w-md bg-app-surface border border-app-borderSubtle rounded-2xl p-8 shadow-2xl flex flex-col items-center text-center gap-5 animate-fade-in">
          ...
          <div class="w-12 h-12 rounded-2xl bg-app-hoverSubtle border border-app-borderSubtle flex items-center justify-center text-app-textPrimary">
            <i data-lucide="clock" class="w-6 h-6 text-amber-500"></i>
          </div>

          <div class="flex flex-col gap-1.5">
            <h2 class="text-[18px] font-semibold text-app-textPrimary">Registration Submitted</h2>
            <p class="text-[13px] text-app-textSecondary leading-relaxed">
              Your account (<strong class="text-app-textPrimary">${escapeHtml(registrationPendingUser.email)}</strong>) is pending administrator approval.
            </p>
          </div>
      ...
      <div class="w-full max-w-md bg-app-surface border border-app-borderSubtle rounded-2xl p-8 shadow-2xl flex flex-col gap-6 animate-fade-in">
        ...
        <div class="flex items-center bg-app-input p-1 rounded-xl border border-app-borderSubtle text-[13px]">
          <button 
            ...
            class="flex-1 py-1.5 rounded-lg font-medium transition-all ${activeAuthTab === 'signin' ? 'bg-app-surface text-app-textPrimary shadow-sm' : 'text-app-textMuted hover:text-app-textPrimary'}">
            Sign In
          </button>
          <button 
            onclick="setAuthTab('signup')"
            class="flex-1 py-1.5 rounded-lg font-medium transition-all ${activeAuthTab === 'signup' ? 'bg-app-surface text-app-textPrimary shadow-sm' : 'text-app-textMuted hover:text-app-textPrimary'}">
            Sign Up
          </button>
        </div>
          ...
          <form onsubmit="handleLoginSubmit(event)" class="flex flex-col gap-4 text-[13px]">
            ...
            <div class="flex flex-col gap-1">
              <div class="flex items-center justify-between">
                <label class="font-medium text-app-textSecondary">Password</label>
              </div>
              <input 
                type="password" 
                id="login-password" 
                ...
                value="admin123"
                placeholder="••••••••" 
                class="bg-app-input border border-app-borderSubtle text-app-textPrimary rounded-xl px-3.5 py-2.5 focus:outline-none focus:border-app-borderActive transition-colors font-mono"
              />
            </div>
          ...
          <form onsubmit="handleRegisterSubmit(event)" class="flex flex-col gap-3.5 text-[13px]">
            <div class="flex flex-col gap-1">
              ...
              <input 
                ...
                class="bg-app-input border border-app-borderSubtle text-app-textPrimary rounded-xl px-3.5 py-2 focus:outline-none focus:border-app-borderActive transition-colors"
              />
            </div>
            ...
            <div class="flex flex-col gap-1">
              ...
              <input 
                ...
                class="bg-app-input border border-app-borderSubtle text-app-textPrimary rounded-xl px-3.5 py-2 focus:outline-none focus:border-app-borderActive transition-colors font-mono"
              />
            </div>
