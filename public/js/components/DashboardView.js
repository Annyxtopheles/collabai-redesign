// DashboardView.js - Clean, refined typography & all-white agent icons
    ...
    <div class="flex-1 flex flex-col h-full overflow-y-auto bg-app-canvas">
      ...
      <div class="p-8 max-w-[1200px] mx-auto w-full flex flex-col gap-7">
        ...
        <div class="flex flex-col gap-1">
          ...
          <p class="text-[14px] text-app-textSecondary">You have 12 active automations running across ${projects.length} projects.</p>
        </div>
        ...
        <div class="w-full bg-app-surface border border-app-borderSubtle rounded-xl p-3.5 flex flex-col gap-3 shadow-lg">
          <div class="flex items-center gap-2.5">
            ...
            <input 
              ...
              class="flex-1 bg-transparent text-white text-[14px] placeholder-app-textMuted focus:outline-none"
            />
            <div class="flex items-center gap-2">
              ...
              <button 
                ...
                class="bg-app-accent hover:bg-app-accentHover text-white font-medium text-[13px] px-4 py-1.5 rounded-lg transition-colors shadow-sm">
                Send
              </button>
            </div>
          </div>
          ...
          <div class="flex items-center gap-2 pt-0.5 flex-wrap">
            <button onclick="setDashboardPrompt('#Resume Review')" class="text-[11.5px] bg-app-input hover:bg-app-hover text-app-textSecondary hover:text-white px-2.5 py-1 rounded-md border border-app-borderSubtle transition-colors">#Resume Review</button>
            <button onclick="setDashboardPrompt('#Color Palette Gen')" class="text-[11.5px] bg-app-input hover:bg-app-hover text-app-textSecondary hover:text-white px-2.5 py-1 rounded-md border border-app-borderSubtle transition-colors">#Color Palette Gen</button>
            <button onclick="setDashboardPrompt('#Aster Architect')" class="text-[11.5px] bg-app-input hover:bg-app-hover text-app-textSecondary hover:text-white px-2.5 py-1 rounded-md border border-app-borderSubtle transition-colors">#Aster Architect</button>
            <button onclick="setDashboardPrompt('#New Agent')" class="text-[11.5px] bg-app-input hover:bg-app-hover text-app-textSecondary hover:text-white px-2.5 py-1 rounded-md border border-app-borderSubtle transition-colors">#New Agent</button>
          </div>
        </div>
        ...
        <div class="grid grid-cols-1 lg:grid-cols-3 gap-5">
          ...
          <!-- Left: Most Accessed Agents List with White Monochrome Icons (2 cols) -->
          <div class="lg:col-span-2 bg-app-surface border border-app-borderSubtle rounded-xl p-5 flex flex-col gap-3.5">
            ...
            <div class="flex flex-col divide-y divide-app-borderSubtle">
              ${agents.slice(0, 5).map(agent => `
                <div class="flex items-center justify-between py-3 cursor-pointer hover:bg-app-hover/50 px-2 rounded-lg transition-colors" onclick="appStore.createConversation('${agent.name}', '', '${agent.id}')">
                  <div class="flex items-center gap-3">
                    ...
                    <div class="flex flex-col">
                      <span class="text-[13.5px] font-medium text-white">${agent.name}</span>
          ...
          <div class="flex flex-col gap-4">
            ...
            <div class="bg-app-surface border border-app-borderSubtle rounded-xl p-5 flex flex-col gap-2.5">
              ...
              <button onclick="appStore.createConversation('New Chat', '')" class="w-full bg-app-accent hover:bg-app-accentHover text-white font-medium text-[13px] py-2 rounded-lg transition-colors">
                Start New Chat
              </button>
