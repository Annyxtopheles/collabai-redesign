          ...
          <div class="mt-2 pt-4 border-t border-app-borderSubtle flex flex-col gap-4">
            <div class="flex items-center justify-between">
              <div class="flex items-center gap-3">
                <div class="w-8 h-8 rounded-xl bg-app-hoverSubtle border border-app-borderSubtle flex items-center justify-center text-app-textPrimary">
                  <i data-lucide="${currentTheme === 'saas' ? 'sparkle' : (currentTheme === 'synthwave' ? 'zap' : (currentTheme === 'crt' ? 'tv' : (currentTheme === 'pink' ? 'flower-2' : (currentTheme === 'dark' ? (state.darkAmbientStyle === 'stars' ? 'sparkles' : (state.darkAmbientStyle === 'matrix' ? 'binary' : 'orbit')) : 'binary'))))}" class="w-4 h-4 ${ambientEnabled ? (currentTheme === 'saas' ? 'text-blue-400' : (currentTheme === 'synthwave' ? 'text-pink-400' : (currentTheme === 'crt' ? 'text-emerald-400' : (currentTheme === 'pink' ? 'text-pink-400' : 'text-emerald-400')))) : 'text-app-textMuted'}"></i>
                </div>
                <div class="flex flex-col">
